<#-- @ftlvariable name="regexp" type="com.bidanet.springmvc.demo.jkbuilder.annotation.JkVerifyRegExp" -->
<#-- @ftlvariable name="verifyInfo" type="com.bidanet.springmvc.demo.jkbuilder.type.VerifyInfo" -->
